# doQumentation — Boarisch (Bavarian)

This is a deployment repository for [bar.doqumentation.org](https://bar.doqumentation.org), the Boarisch (Bavarian) version of [doQumentation](https://doqumentation.org).
